#Level 3
#(that one level with the puzzle)
...
#This is a function for displaying a puzzle that appears later in the level
...
def level_3(inventory, health):
    #These variables keep track of whether or not the user
